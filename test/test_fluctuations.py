...
from fluctuations import evolve_fluctuations


def test_SK_model_easy():

    J = np.array([[ 0.        ,  0.42132292, -0.25571582, -0.16267926, -0.77219702,
    ...
    _, lyapunov_exponent_t = evolve_fluctuations(data, J, τ, β, γ)

    lyapunov_exponent_test = np.array([0.00292733, 0.00275409, 0.00193802, 0.00127588, 0.00114502, 0.00089046,
                                       0.00068273, 0.00035155, 0.00024733])

    assert np.allclose(lyapunov_exponent_t[0:9, -1], lyapunov_exponent_test)


def test_SK_model_hard():

    J = np.array([[ 0.        ,  0.20437418,  0.18668785, -0.42714492, -0.49929211,
    ...
    lyapunov_exponent_test = np.array([0.00827196, 0.0031224 , 0.00137491, 0.00121955, 0.00080722,
                                       0.00070528, 0.00059945, 0.00056264, 0.00036761])
